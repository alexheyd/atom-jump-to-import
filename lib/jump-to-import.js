  ...
  applyMagicPaths(module) {
    ...
    if (module && magicPath) {
      ...
      if (AtomUtils.isPathAbsolute(magicPath)) {
        realPath = magicPath.replace('/', rootPath);
        ...
        realPath = magicPath;
        // module path is an npm package (e.g with browserify)
      ...
      module.path = skipExtension ? realPath : this.appendFileExtension(realPath);
    }
