module.exports = DefaultConfig = {
  ...
  pathOverrides: {
    ...
    description: 'Use these aliases when overriding path lookups. Separate multiple overrides with a comma, and separate the target string with the override with a colon.<br/><br/> **Example:**<br/>`import FooMixin from "project-name/mixins/foo"` and a path override of `project-name:app` will look for `FooMixin` in `app/mixins/foo` instead.<br/><br/>Use `$PROJECT` to refer to project name listed in packages.json',
    type: 'array',
